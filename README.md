...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/purple-term-6a40
```

A live public deployment of this template is available at [https://purple-term-6a40.templates.workers.dev](https://purple-term-6a40.templates.workers.dev)
